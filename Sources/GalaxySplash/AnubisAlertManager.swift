...
// MARK: -- Anubis Alert Manager

/// Менеджер для показа кастомных alert'ов (бог Анубис)
public final class AnubisAlertManager {
    public static let shared = AnubisAlertManager()
